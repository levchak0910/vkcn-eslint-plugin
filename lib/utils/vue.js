...
const HTML_ELEMENT_NAMES = new Set(require("./html-elements"));
const SVG_ELEMENT_NAMES = new Set(require("./svg-elements"));
const VOID_ELEMENT_NAMES = new Set(require("./void-elements"));
...
function getComponentComments(context) {
  ...
  tokens = sourceCode
    .getAllComments()
    .filter((comment) => /@vue\/component/.test(comment.value));
