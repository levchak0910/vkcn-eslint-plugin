import type * as VAST from "../../eslint-plugin-vue/util-types/ast";
import type { Token, Comment } from "../../eslint-plugin-vue/util-types/node";
import type { ParserServices } from "../../eslint-plugin-vue/util-types/parser-services";
...
export class ReferenceTracker {
  ...
  iterateGlobalReferences(traceMap: TYPES.TraceMap): IterableIterator<{
    node: VAST.ESNode;
    path: string[];
    type: symbol;
    info: any;
  ...
  iterateCjsReferences(traceMap: TYPES.TraceMap): IterableIterator<{
    node: VAST.ESNode;
    path: string[];
    type: symbol;
    info: any;
  ...
  iterateEsmReferences(traceMap: TYPES.TraceMap): IterableIterator<{
    node: VAST.ESNode;
    path: string[];
    type: symbol;
    info: any;
